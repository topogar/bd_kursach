CREATE TABLE IF NOT EXISTS REWARD(
  ...
  reward_nm VARCHAR(40) NOT NULL
);

CREATE TABLE IF NOT EXISTS CINEMATIC_UNIVERSE(
...
CREATE TABLE IF NOT EXISTS MOVIE(
  ...
  fees_amt MONEY,
  rating_prt NUMERIC CHECK(rating_prt >= 0 AND 10 >= rating_prt),
...
CREATE TABLE IF NOT EXISTS REWARD_X_MOVIE(
...
CREATE TABLE IF NOT EXISTS CHARACTER_X_MOVIE(
  character_id INTEGER NOT NULL,
  movie_id INTEGER NOT NULL,
  position_txt VARCHAR(100),
  gender_code VARCHAR(20),
  die_flg BOOLEAN,
...
CREATE TABLE IF NOT EXISTS MOVIE_X_PARTICIPANT(
  movie_id INTEGER NOT NULL,
  participant_id INTEGER NOT NULL,
  payment_amt MONEY,
...
CREATE TABLE IF NOT EXISTS CINEM_UNIVERSE_X_ORGANIZATION(
  cinematic_universe_id INTEGER NOT NULL,
